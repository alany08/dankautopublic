...
try:
    ...
    if sys.argv[1] == "alan":
        ...
        #That's boredperson
        #email = "alanyu08+storage9@gmail.com"
        #got banned
        #email = "alanyu08+coinfarmeralt@gmail.com"
        #pwd = "New Passcode"
        #banned too
        #email = "diramo5835@ecofreon.com"
        #pwd = "Le Mot De Passe"
        """
        Account permanantly disabeled
        email = "koxeke5293@sinagalore.com"
        pwd = "Stop Banning Me"
        """
        usekno = False
        useapple = True
        ...
        keepawake = True
    elif sys.argv[1] == "wisdom-main":
        email = "wisdom.li.1035@gmail.com"
        pwd = "johnmuir18"
        usekno = False
        useapple = True
        usepizza = True
    ...
    if sys.argv[1] == "cfg1":
        ...
        pwd="LynbrookHighSchool!"
        """
        #Recovered, not updated values (huskies)
        #Token instead
        token = "ODI5MjE5NTk1NzAwNjY2NDQ4.YeTCIw.RWtzzd__n0I2PL1SYc2Aw1lK16U"
        #Url/channel to start in
        start_url = "https://discord.com/channels/932443846900600893/932449816510877756"
        usekno = False
        useapple = False
        usepizza = True
        usespinner = False
        ...
        channelindex = 6
        """
        loggingurl = "https://discord.com/api/webhooks/932455039417610261/5omGo06dD4d6NLz1Qgut4aLYSnL_8-vafKZXPPqTrZ3O5UUBYPpwspv_UWhtDvg4exV1"
        sleeptime = 10800
        chromepath = "C:\\Users\\ning\\Documents\\chromedriver.exe"
        keepawake = False
    elif sys.argv[1] == "cfg3":
        """
        email = "dankmemerfarmNZ@gmail.com"
        pwd = "yesyes123yesyes"
        """
        #Still disabled
        #token
        token = "OTAzMDkxMTkzNjUzNjU3NjQw.YeTNeA.3B7IqUCvlX4sbohD8AHZPmapdhk"
        #url
        start_url = "https://discord.com/channels/932443846900600893/932449839340486657"
        usekno = False
        useapple = False
        usepizza = True
        usespinner = False
        ...
        channelindex = 8
        """
        loggingurl = "https://discord.com/api/webhooks/932454792553451590/YujwOllODOiZuKrgTr1sQtq6NlJxUY4esl5nn3Q8XhL2WXSdqVRaxOMJ2uVF8reHf27P"
        sleeptime = 10800
        chromepath = "C:\\Users\\ning\\Documents\\chromedriver.exe"
        keepawake = True
    elif sys.argv[1] == "cfg4":
        #Entity, YEET
        token = "NTM4NzgxNjYzNjI3NTc1MzE4.YirEUA.Wp5X0WjCBpoQC8HFDpEsg2rFWJA"
        start_url = "https://discord.com/channels/932443846900600893/934988595410898944"
        usekno = False
        useapple = False
        usepizza = True
        usespinner = False
        ...
        autosell = False
        usepod = False
        loggingurl = "https://discord.com/api/webhooks/934989271587258419/A9QxQVY0yYeOVPSHy3E0janxk-xUEc9T97mjKDCO-R_pC7PeGcptm104PPBvIAsR8LR5"
        sleeptime = 10800
        chromepath = "C:\\Users\\ning\\Documents\\chromedriver.exe"
        keepawake = True
    elif sys.argv[1] == "cfg5":
        #Xinhao is ded
        token = "NzQzMjAwNzc1ODM2MDA4NDg4.YgxAIQ.NYDowCyPQxA5IeGWKAefCl1syLA"
        start_url = "https://discord.com/channels/932443846900600893/942943864233275403"
        usekno = False
        useapple = False
        usepizza = True
        usespinner = False
        ...
        autosell = False
        usepod = False
        loggingurl = "https://discord.com/api/webhooks/942944246275661885/5gUR69xvSVgB6HO8Zvl7PlVhXaJv1jsxzQpgcyOiTuYXF99BFkoZEIlNDuaHhKOxJI_h"
        sleeptime = 10800
        chromepath = "C:\\Users\\ning\\Documents\\chromedriver.exe"
        keepawake = True
    elif sys.argv[1] == "client1":
        #Wait until service resumes
        token = "Njg3OTEyODMwODg3OTE5NjI5.YhByng.s8qNwXWLr4o0rbbEXI-zrgUZDK4"
        start_url = "https://discord.com/channels/932443846900600893/932877388088487997"
        usekno = False
        useapple = False
        usepizza = True
        usespinner = False
        ...
        autosell = False
        usepod = False
        loggingurl = "https://discord.com/api/webhooks/932876856422694923/R7tMwpoWBhCeTUHwF3ObqXq79wvOe8sjIZcEZjKnKCfr3km923DQUmVTqWpMQm1wWw4s"
        sleeptime = 10800
        chromepath = "C:\\Users\\ning\\Documents\\chromedriver.exe"
        keepawake = True
    elif sys.argv[1] == "me":
        #Beta alt
        token = "OTUxMzgwOTI1Nzc2ODEwMDE0.YimopA.Ascs8ODNFGDb7tGDlruxNfrKbv4"
        start_url = "https://discord.com/channels/951381099769114644/951381099769114647"
        usekno = False
        useapple = False
        usepizza = False
        usespinner = False
        ...
        autosell = False
        usepod = False
        loggingurl = "https://discord.com/api/webhooks/951382425806733322/6OVa7FjSwl96EEUk5BnFpRoLAg-cQ17H_fD2LBpDtHgr5AoHmiGKGbjb6v__-9RDgr_i"
        sleeptime = 10800
        chromepath = "C:\\Users\\ning\\Documents\\chromedriver.exe"
        keepawake = True
